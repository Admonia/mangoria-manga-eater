...
//     // Function to add a new anime
//     const addAnime = (setList, newItem, storageKey) => {
//         if (newItem.trim()) {
//             setList((prevList) => {
...
//                         placeholder="Add new trending anime" 
//                     />
//                     <button onClick={() => setNewTrendingAnime(addAnime(setTrendingAnime, newTrendingAnime, 'trendingAnime'))}>
//                         Add
//                     </button>
//                 </div>
...
//                         placeholder="Add new watchlist item" 
//                     />
//                     <button onClick={() => setNewWatchlistItem(addAnime(setWatchlist, newWatchlistItem, 'watchlist'))}>
//                         Add
//                     </button>
//                 </div>
...
//                         placeholder="Add new recommendation" 
//                     />
//                     <button onClick={() => setNewRecommendation(addAnime(setRecommendations, newRecommendation, 'recommendations'))}>
//                         Add
//                     </button>
//                 </div>
//             </div>
...
//     // Function to add a new trending anime
//     const addTrendingAnime = () => {
//         if (newTrendingAnime.trim()) {
//             const updatedTrending = [...trendingAnime, newTrendingAnime];
//             setTrendingAnime(updatedTrending);
//             localStorage.setItem('trendingAnime', JSON.stringify(updatedTrending));
//             setNewTrendingAnime('');
//         }
//     };
...
//                             <li key={index}>
//                                 {anime}
//                                 <button onClick={() => deleteItem(trendingAnime, setTrendingAnime, index, 'trendingAnime')}>Delete</button>
//                             </li>
//                         ))}
//                     </ul>
//                     <input 
...
//                         placeholder="Add new trending anime" 
//                     />
//                     <button onClick={addTrendingAnime}>Add</button>
//                 </div>
//                 {/* Third Card: Your Watchlist */}
//                 <div className="card">
//                     <h2>Your Watchlist</h2>
...
//                             <li key={index}>
//                                 {item}
//                                 <button onClick={() => deleteItem(watchlist, setWatchlist, index, 'watchlist')}>Delete</button>
//                             </li>
//                         ))}
//                     </ul>
//                     <input 
...
//                             <li key={index}>
//                                 {item}
//                                 <button onClick={() => deleteItem(recommendations, setRecommendations, index, 'recommendations')}>Delete</button>
//                             </li>
//                         ))}
//                     </ul>
//                     <input 
